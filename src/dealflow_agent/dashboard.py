...
/* Header row: LAUNCHY identity + GitHub source link side by side */
...
.repo-link { flex: 0 0 auto; margin-top: 8px;
...
.ticker {
  position: relative; background: #050507; width: 100%;
  border: 0; border-bottom: 1px solid rgba(57,255,20,.5);
  box-shadow: 0 0 28px rgba(57,255,20,.14), inset 0 1px 0 rgba(57,255,20,.16);
